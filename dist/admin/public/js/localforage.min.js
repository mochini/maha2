...
*/
!function (a) {
    if ("object" == (typeof exports === "undefined" ? "undefined" : (0, _typeof3.default)(exports)) && "undefined" != typeof module) module.exports = a();else if ("function" == typeof define && define.amd) define([], a);else {
    ...
    return function a(b, c, d) {
        function e(g, h) {
            ...
            function d() {}function e(a) {
                ...
                var b = a && a.then;if (a && "object" == (typeof a === "undefined" ? "undefined" : (0, _typeof3.default)(a)) && "function" == typeof b) return function () {
                    b.apply(a, arguments);
                };
            }function i(a, b) {
                function c(b) {
            ...
            function d(a, b) {
                ...
                try {
                    if (!ga) return !1;var a = "undefined" != typeof openDatabase && /(Safari|iPhone|iPad|iPod)/.test(navigator.userAgent) && !/Chrome/.test(navigator.userAgent) && !/BlackBerry/.test(navigator.platform),
                        b = "function" == typeof fetch && fetch.toString().indexOf("[native code") !== -1;return (!a || b) && "undefined" != typeof indexedDB && "undefined" != typeof IDBKeyRange;
                } catch (a) {
                    return !1;
                }
            }function g() {
                ...
                var b = this,
                    ...
                    var a = ia[b._dbInfo.name];if (a && a.dbReady) return a.dbReady;
                });return k(c, a, a), c;
            }function y(a) {
                function b() {
                    return ja.resolve();
                    ...
                    d[e] = a[e];
                }ia || (ia = {});var f = ia[d.name];f || (f = { forages: [], db: null, dbReady: null, deferredOperations: [] }, ia[d.name] = f), f.forages.push(c), c._initReady || (c._initReady = c.ready, c.ready = x);for (var g = [], h = 0; h < f.forages.length; h++) {
                ...
                var b,
                    ...
                    c = na.indexOf(a[b]), d = na.indexOf(a[b + 1]), e = na.indexOf(a[b + 2]), f = na.indexOf(a[b + 3]), k[i++] = c << 2 | d >> 4, k[i++] = (15 & d) << 4 | e >> 2, k[i++] = (3 & e) << 6 | 63 & f;
                }return j;
            }function I(a) {
                var b,
                    c = new Uint8Array(a),
                    d = "";for (b = 0; b < c.length; b += 3) {
                    d += na[c[b] >> 2], d += na[(3 & c[b]) << 4 | c[b + 1] >> 4], d += na[(15 & c[b + 1]) << 2 | c[b + 2] >> 6], d += na[63 & c[b + 2]];
            ...
            }var fa = "function" == typeof Symbol && "symbol" == (0, _typeof3.default)(Symbol.iterator) ? function (a) {
                return typeof a === "undefined" ? "undefined" : (0, _typeof3.default)(a);
            } : function (a) {
                return a && "function" == typeof Symbol && a.constructor === Symbol && a !== Symbol.prototype ? "symbol" : typeof a === "undefined" ? "undefined" : (0, _typeof3.default)(a);
            },
                ga = e();"undefined" == typeof _bluebird2.default && a(3);var ha,
                ia,
                ja = _bluebird2.default,
