...
var handleRefresh = function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee5(req, trx, result, options) {
    var refreshCreator;
        ...
        switch (_context5.prev = _context5.next) {
          ...
          case 3:
            ...
            return options.knex.transaction(function () {
              var _ref3 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee4(trx) {
                var messages;
                  ...
                  while (1) {
                    switch (_context4.prev = _context4.next) {
                      ...
                      case 2:
                        ...
                        _context4.next = 5;
                        return Promise.map(_coerceArray(messages), function () {
                              ...
                              while (1) {
                                switch (_context3.prev = _context3.next) {
                                  case 0:
                                    ...
                                    _context3.next = 5;
                                    return Promise.map(_coerceArray(targets), function () {
                                      var _ref5 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(target) {
...
var handleMessages = function () {
  var _ref6 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee9(req, trx, result, options) {
    var messageCreator;
      ...
      while (1) {
        switch (_context9.prev = _context9.next) {
          ...
          case 3:
            _context9.next = 5;
            return options.knex.transaction(function () {
              var _ref7 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee8(trx) {
                var messages;
                  ...
                  while (1) {
                    switch (_context8.prev = _context8.next) {
                      ...
                      case 2:
                        ...
                        _context8.next = 5;
                        return Promise.map(_coerceArray(messages), function () {
                          var _ref8 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee7(message) {
                            var channel, targets;
                              ...
                              while (1) {
                                switch (_context7.prev = _context7.next) {
                                  case 0:
                                    ...
                                    _context7.next = 5;
                                    return Promise.map(_coerceArray(targets), function () {
                                      var _ref9 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee6(target) {
...
(function () {
  ...
  reactHotLoader.register(handleRefresh, 'handleRefresh', 'unknown');
  reactHotLoader.register(handleMessages, 'handleMessages', 'unknown');
  reactHotLoader.register(_getChannel, '_getChannel', 'unknown');
  reactHotLoader.register(_getTarget, '_getTarget', 'unknown');
  reactHotLoader.register(_getForAction, '_getForAction', 'unknown');
