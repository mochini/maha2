...
var CreateProfileTypes = new _migration2.default({
      ...
      return regeneratorRuntime.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            ...
            case 2:
              _context.next = 4;
              return knex('maha_profile_types').insert([{ text: 'google' }, { text: 'facebook' }]);
...
var _default = CreateProfileTypes;
...
(function () {
  ...
  reactHotLoader.register(CreateProfileTypes, 'CreateProfileTypes', 'unknown');
