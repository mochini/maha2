...
var CreateEmailTemplates = new _migration2.default({
      ...
      return regeneratorRuntime.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              _context.next = 2;
              return knex.schema.createTable('maha_email_templates', function (table) {
      ...
      return regeneratorRuntime.wrap(function _callee2$(_context2) {
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              _context2.next = 2;
              return knex.schema.dropTable('maha_email_templates');
...
var _default = CreateEmailTemplates;
...
(function () {
  ...
  reactHotLoader.register(CreateEmailTemplates, 'CreateEmailTemplates', 'unknown');
