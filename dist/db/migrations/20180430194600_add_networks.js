...
var AddNetworks = new _migration2.default({
      ...
      return regeneratorRuntime.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              _context.next = 2;
              return knex('maha_profile_types').insert([{ text: 'instagram' }, { text: 'dropbox' }, { text: 'box' }]);
...
(function () {
  ...
  reactHotLoader.register(AddNetworks, 'AddNetworks', 'unknown');
