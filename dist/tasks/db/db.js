    ...
    return _regenerator2.default.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            return _context.abrupt('return', _migrate('up'));
    ...
    return _regenerator2.default.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            return _context2.abrupt('return', _migrate('down'));
...
var _migrate = function () {
  var _ref3 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee3(direction) {
...
var _getSortedFiles = function _getSortedFiles(targetPath) {
  ...
  return (0, _collect_objects2.default)('db/migrations/*').filter(function (file) {
...
var _filterScripts = function () {
  var _ref5 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee6(scripts, down) {
    var sorted;
        ...
        switch (_context6.prev = _context6.next) {
          case 0:
            ...
            return (0, _bluebird.filter)(sorted, function () {
              var _ref6 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee5(script) {
...
var _hasScriptBeenRun = function () {
  var _ref7 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee7(migration, run) {
    var result;
      ...
      while (1) {
        switch (_context7.prev = _context7.next) {
          ...
          case 2:
            ...
            return _context7.abrupt('return', parseInt(result[0].count) === 1);
...
var _runMigrations = function _runMigrations(migrations, direction) {
  ...
  return (0, _bluebird.mapSeries)(migrations, function () {
    var _ref8 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee9(migration) {
          ...
          switch (_context9.prev = _context9.next) {
            case 0:
              ...
              return _knex2.default.transaction(function () {
                var _ref9 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee8(trx) {
