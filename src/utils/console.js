...
export const log = (prefix, color, entity, message) => console.log(color(_.padEnd(prefix, 2)) + grey(`[${entity}]`) + white(`: ${message}`))
...
export const action = (action, target) => console.log(green(_.padEnd(action, 10)) + ' ' + white(target))
